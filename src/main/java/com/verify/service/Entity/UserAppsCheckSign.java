...
@Entity
@Table(
   name = "pangolin_userappssign"
)
public class UserAppsCheckSign {
   @Id
   @GeneratedValue(
   ...
   public void setApps_sign(String apps_sign) {
      this.apps_sign = apps_sign;
   }
   ...
   public void setApps_is_sign(int apps_is_sign) {
      this.apps_is_sign = apps_is_sign;
   }
